...
export default function FAQItem({ questions, index, question }) 
{
    ...
    const openIcon = (
        <svg xmlns="http://www.w3.org/2000/svg" width="39" height="38" viewBox="0 0 39 38" fill="none">
            <path d="M19.1582 4.1792V32.6792" stroke="#90946B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M4.9082 18.4292H33.4082" stroke="#90946B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    )

    const closeIcon = (
        <svg xmlns="http://www.w3.org/2000/svg" width="39" height="38" viewBox="0 0 39 38" fill="none">
            <path d="M4.7627 33.25L33.2627 4.75" stroke="#90946B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M33.2627 33.25L4.7627 4.75" stroke="#90946B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    )
