...
export default function AboutTherapistsPledge() 
{
    const navigate = useNavigate()

    return (
        <div className='WhySonderContainerUpgraded'>
                <div style={{ marginBottom: 0 }} className='WhySonderHeader'>
                ...
                <div className='WhySonderItemsContainerPledge'>
                    <div className='WhySonderItemsFirstRow'>
                        <div className='WhySonderItem'>
                            ...
                            <div  className='WhySonderItemInfo'>
                                ...
                                <div className='WhySonderItemBody'>
                                    I am individually, group, and peer supervised.
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='WhySonderItem'>
                            ...
                            <div  className='WhySonderItemInfo'>
                                ...
                                <div className='WhySonderItemBody'>
                                    I make sure to transcribe all my notes in a confidential folder on my device.
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='WhySonderItem'>
                            ...
                            <div  className='WhySonderItemInfo'>
                                ...
                                <div className='WhySonderItemBody'>
                                    I go through all the needed forms, assessments, or notes before my sessions with the clients.
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='WhySonderItem'>
                            ...
                            <div  className='WhySonderItemInfo'>
                                ...
                                <div className='WhySonderItemBody'>
                                    I read and write a lot. In fact, I write a blog post every other month for TSH's website.
                                </div>
                            </div>
                        </div>
                    </div>

                    <div className='WhySonderItemsSecondRow'>
                        <div className='WhySonderItem'>
                            <div className='WhySonderItemSVG'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="104" height="103" viewBox="0 0 104 103" fill="none">
                                    <path d="M40.3556 0H28.2671V102.26H40.3556V0Z" fill="#FFF1CE"/>
                            ...
                            <div  className='WhySonderItemInfo'>
                                <div style={{ height: '20%', alignItems: 'center' }} className='WhySonderItemTitle'>
                                    Trained
                                </div>
                                <div style={{ height: '70%', alignItems: 'center' }} className='WhySonderItemBody'>
                                    I have at least one Master's Degree in the field of Psychology.
                                </div>
                            </div>
                        </div>
